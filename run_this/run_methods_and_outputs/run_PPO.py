        ...
        while not done:
            ...
            if total_steps % args.evaluate_freq == 0:
                ...
                print(
                    ...
                    f' Hit Rate: {evaluate_cur_hitrate:.2f}, All Hit Rate: {evaluate_all_hitrate:.2f},time:{evaluate_time:.2f}.')
...
def run_ppo():
    ...
    parser.add_argument("--l2_reg_factor", type=float, default=0.8, help="L2 regularization factor")  # 添加l2
    ...
    parser.add_argument('--initial_clip', type=float, default=0.6, help='Initial value of clip parameter')
    parser.add_argument('--target_clip', type=float, default=0.3, help='Target value of clip parameter')
    parser.add_argument('--decay_steps', type=float, default=5000, help='Decay value of clip parameter')
